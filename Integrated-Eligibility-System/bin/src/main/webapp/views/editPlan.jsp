...
<body>
	...
	<div>
		...
		<form:form action="/updatePlan" methodParam="PUT" modelAttribute="plan" >
			<table>
				<tr>
					<td>ID :</td>
				...
				<tr>
					...
					<td align="center"><input type="submit" id="regBtn" title="Update Plan"/></td>
				</tr>
			</table>
		</form:form>
	</div>
